...
| Level | Name | Tuning-Trials | Base Learner | CV-Folds | RAM-Bedarf |
|-------|------|--------------|-------------|----------|------------|
| 1 | Minimal | 1 sequentiell | 1 Kern | sequentiell | ~1× |
| 2 | Moderat | 1 sequentiell | alle Kerne | sequentiell | ~1× |
| 3 | Hoch | 2–4 parallel | Kerne/Workers | 2–4 parallel | ~2–3× |
| 4 | Maximum | max. parallel | Kerne/Workers | alle parallel | ~3–5× |
