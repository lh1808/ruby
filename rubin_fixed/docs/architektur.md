...
Optuna optimiert die Nuisance-Modelle (Outcome, Propensity). Task-basiertes Sharing: identische Lernaufgaben werden dedupliziert. Best-Scores werden als `tuning_best__<task>` nach MLflow geloggt.
