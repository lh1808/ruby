...
try:
    ...
    _logger.warning(
        ...
        "Installation: pixi install (scikit-uplift ist als Conda-Dependency konfiguriert) "
        "oder pip install 'scikit-uplift>=0.5'"
    )
...
def generate_sklift_plots(
    ...
    """Erzeugt nur die scikit-uplift Plots (ohne DRTester).

    Schnell (~2-5s), da keine Bootstrap-Berechnungen nötig.
