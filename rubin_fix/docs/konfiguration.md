...
|-------|------|-------------|----------|------------|
| 1 | Minimal | 1 Kern | sequentiell | ~1× |
| 2 | Moderat | alle Kerne | sequentiell | ~1× |
| 3 | Hoch | Kerne/Folds | 2–4 parallel | ~2–3× |
| 4 | Maximum | Kerne/Folds | alle parallel | ~3–5× |

Bei Level 3–4 werden die CPU-Kerne proportional auf die parallelen Folds aufgeteilt, sodass keine Übersubskription entsteht (z. B. 16 Kerne, 4 Folds → 4 Kerne pro Fold). Die Feature-Selektion respektiert ebenfalls den parallel_level (Level 1 → `n_jobs=1`).

**Warum?**  
Ohne festen Seed werden Ergebnisse (insb. bei Optuna und Subsampling) schwer vergleichbar.
Level 2 ist der sichere Default. Level 3–4 beschleunigen den Lauf deutlich, erhöhen aber den RAM-Verbrauch proportional zur Anzahl paralleler Folds.
