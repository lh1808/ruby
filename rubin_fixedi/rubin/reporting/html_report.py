...
class ReportCollector:
    ...
    def add_config(self, cfg) -> None:
        ...
        self.config_summary = {
            ...
            "tuning_metric": getattr(cfg.tuning, "metric", "roc_auc"),
...
def generate_html_report(collector: ReportCollector, output_path: str) -> str:
    ...
    if cs.get("tuning_enabled") and collector.tuning_scores:
        ...
        # Config info
        h += '<div class="cg">'
        h += f'<div class="cd"><div class="cd-l">Metrik</div><div class="cd-v">{escape(str(cs.get("tuning_metric","roc_auc")))}</div></div>'
